<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_Zqsq.aspx.cs" Inherits="user" %>
			...
			<table cellpadding="3" cellspacing="1" border="0" class="tableBorder" align="center">
				<tr>
					<th class="tableHeaderText" style="height: 25px">
                        ...
                        <asp:Label ID="lbl_title" runat="server" ForeColor="White">申请中期检查</asp:Label>
                        </span></th>
				<tr>
					<td height="23">
                        <asp:CheckBox ID="cbx_1" runat="server" style="color: #000066" Text="申请中期检查" />
&nbsp; <asp:Button
                            ID="btn_ok" runat="server" OnClick="btn_ok_Click" Text="确定" Width="39px" />
                    </td>
				</tr>
				<tr>
			...
			<table cellpadding="3" cellspacing="1" border="0" class="tableBorder" align="center">
				<tr>
					<th class="tableHeaderText" style="height: 25px">
                        <span style="font-size: 11pt; color: #FFFFFF;">
                        <asp:Label ID="lbl_title0" runat="server" ForeColor="White">上传中期检查</asp:Label>
                        </span></th>
				<tr>
					<td height="23">
                        <asp:HyperLink ID="hl_2" runat="server" ForeColor="#000066" 
                            NavigateUrl="./templete/防灾科技学院教研教改项目中期检查申请表.doc">下载中期检查模板</asp:HyperLink>
                    </td>
				</tr>
				<tr>
                        <TD id="id_Change0" runat=server visible=True class="forumRowHighlight" 
                            style="height: 30px" v>
				...
				<tr>
					<td height="23">
                        <asp:HyperLink ID="hl_1" runat="server" ForeColor="#000066">查看中级检查申请表</asp:HyperLink>
                    </td>
				</tr>
			</table>
			<br>
