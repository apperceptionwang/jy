...
public partial class Index_zg : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string str_sql;
            str_sql = "SELECT top 10 hot,leixing,id,iif(len(title)>23,left(title,22)+'…',title)+'('+format(shijian,'mm-dd')+')' as biaoti FROM news where leibie = '新闻' and leixing='0'  order by shijian asc,id asc";
