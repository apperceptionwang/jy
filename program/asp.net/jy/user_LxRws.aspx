<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_LxRws.aspx.cs" Inherits="user" %>
			...
			<table cellpadding="3" cellspacing="1" border="0" class="tableBorder" align="center">
				<tr>
					<th class="tableHeaderText" style="height: 25px">
                        ...
                        <asp:Label ID="lbl_title" runat="server" ForeColor="White">上传任务书</asp:Label>
                        </span></th>
				<tr>
					<td height="23">
                        <asp:HyperLink ID="hl_2" runat="server" ForeColor="#000066" 
                            NavigateUrl="./templete/防灾科技学院教育研究与教学改革项目任务书.doc">下载任务书模板</asp:HyperLink>
                    </td>
				</tr>
				<tr>
				...
				<tr>
					<td height="23">
                        <asp:HyperLink ID="hl_1" runat="server" ForeColor="#000066">查看任务书</asp:HyperLink>
                    </td>
				</tr>
				<tr>
