<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_xmChange.aspx.cs" Inherits="user" %>
			...
			<table cellpadding="3" cellspacing="1" border="0" class="tableBorder" align="center">
				<tr>
					<th class="style1">
                        ...
                        <asp:Label ID="lbl_title" runat="server" ForeColor="White" Font-Size="12pt">项目变更申请</asp:Label>
                        </span></th>
				<tr>
					<td height="23">
                        <asp:HyperLink ID="hl_2" runat="server" ForeColor="#000066" 
                            NavigateUrl="./templete/防灾科技学院教学研究与教学改革项目变更审批表.doc">下载项目变更审批表模板</asp:HyperLink>
                    </td>
				</tr>
				<tr>
				...
				<tr>
					<td height="23">
                        <asp:HyperLink ID="hl_1" runat="server" ForeColor="#000066">查看项目变更审批表</asp:HyperLink>
                    </td>
				</tr>
				<tr>
