<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_top.aspx.cs" Inherits="user" %>
						...
						<TABLE cellSpacing="0" cellPadding="0" width="100%" align="left" border="0">
							<TBODY>
								<TR>
									...
									<TD align="left" id="AdminTableTitleLink" style="BORDER-BOTTOM: #ffffff 0px solid; width: 453px;"><B><FONT color="#ffffff">欢迎登陆教研教改项目评审系统&nbsp;<asp:Label ID="lbl_welcom" runat="server" ForeColor="#CC0000"></asp:Label>
                                        &nbsp;&nbsp;&nbsp;</FONT></B></TD>
