...
function WebCalendar() //初始化日历的设置
{
      ...
      this.yearFall     = 80;             //定义显示的年份下拉框的年差值，如果今年是2000年，这里设置为50，就显示1950－2050
...
function writeIframe()
{
      ...
      "      </td><td align=center><input name=today type=button value='Today' ondblclick='this.blur()' style='width: 50' title='当前日期&#13;快捷键：T'"+
...
function writeIframe_date()
{
      ...
      "          onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
      "          onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>"+
      "      <td width=50 id=meizzYearMonth title='点击此处选择月份' onclick='returnDate_date()'"+
      "          onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
      "          onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>"+
      "      <td width=15 class=bg title='向后翻 1 月&#13;快捷键：→' onclick='parent.nextM()' style='cursor: hand'><b>&gt;</b></td></tr></table>"+
      "</td></tr><tr><td height=20><table id=tableWeek border=1 width=140 cellpadding=0 cellspacing=0 ";
      ...
      "</td></tr><tr><td height=20 width=140 bgcolor='"+ WebCalendar.lightColor +"'>"+
      "      <table border=0 cellpadding=1 cellspacing=0 width=140>"+
      "      <tr height = 20><td>注意：凡需要填写年月部分，只要选到月份，日期可以任选。</td></tr>"+
//      "      <tr><td><input name=prevYear title='向前翻 1 年&#13;快捷键：↑' onclick='parent.prevY()' type=button value='&lt;&lt;'"+
//      "      ondblclick='this.blur()' style='meizz:expression(this.disabled=parent.WebCalendar.thisYear==1000)'><input"+
//      "      ondblclick='this.blur()' name=prevMonth title='向前翻 1 月&#13;快捷键：←' onclick='parent.prevM()' type=button value='&lt;&nbsp;'>"+
//      "      </td><td align=center><input name=today type=button value='Today' ondblclick='this.blur()' style='width: 50' title='当前日期&#13;快捷键：T'"+
...
//      "      </td><td align=right><input title='向后翻 1 月&#13;快捷键：→' name=nextMonth onclick='parent.nextM()' type=button value='&nbsp;&gt;'"+
//      "      ondblclick='this.blur()'><input name=nextYear title='向后翻 1 年&#13;快捷键：↓' onclick='parent.nextY()' type=button value='&gt;&gt;'"+
//      "      ondblclick='this.blur()' style='meizz:expression(this.disabled=parent.WebCalendar.thisYear==9999)'></td></tr>"+
      "</table>"+
      "</td></tr><table></form></body></html>";
      with(WebCalendar.iframe)
      {
          ...
          for(var i=0; i<WebCalendar.dayShow; i++)
          {
              ...
              WebCalendar.dayObj[i].onmouseover = dayMouseOver;
              WebCalendar.dayObj[i].onmouseout    = dayMouseOut;
              WebCalendar.dayObj[i].onclick       = returnDate_date;
          }
      }
}
...
{
      var e = window.event.srcElement;     writeIframe_date();
...
function returnDate_date() //根据日期格式等返回用户选定的日期
{
      if(WebCalendar.objExport)
      {
          var returnValue;
