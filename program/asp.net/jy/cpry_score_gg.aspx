    ...
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 553pt; border-collapse: collapse"
            ...
            <tr height="30" style="height: 22.5pt; mso-height-source: userset">
                <td class="xl46" colspan="9" style="border-right: #dcd9a6; border-top: #dcd9a6;
            ...
            <tr height="19" style="font-size: 9pt; font-family: 宋体; height: 14.25pt; mso-height-source: userset">
                <td class="xl30" height="460" rowspan="18" style="border-right: windowtext 0.5pt solid;
                    ...
                    height: 345pt; background-color: transparent" width="41">
                    项目任务</td>
                <td class="xl34" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    ...
                    text-align: center" width="169">
                    内容</td>
                <td colspan="3" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">                </td>
                ...
                <td class="xl34" rowspan="4" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    ...
                    background-color: transparent" width="101">
            ...
            <tr height="30" style="font-size: 10pt; font-family: 宋体; height: 22.5pt">
                ...
                <td colspan="3" class="xl45" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; width: 139pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">
                    主持省局级以上单位综合震情监测和分析预报工作</td>
                <td align="center" class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">
                    0.3/年</td>
                <td width="80" align="center" class="xl48" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="30" style="font-size: 10pt; font-family: 宋体; height: 22.5pt">
                <td height="30" colspan="3" class="xl45" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                ...
                <td width="82" align="center" class="xl48" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="61" style="font-size: 9pt; font-family: 宋体; height: 45.75pt; mso-height-source: userset">
                <td class="xl43" colspan="5" height="61" style="border-right: black 0.5pt solid;
                    border-top: windowtext 0.5pt solid; border-left: windowtext; width: 259pt; border-bottom: windowtext 0.5pt solid;
                    height: 45.75pt; background-color: transparent">
            ...
            <tr height="18" style="font-size: 9pt; font-family: 宋体; height: 13.5pt; mso-height-source: userset">
                <td class="xl31" height="90" rowspan="5" style="border-right: windowtext 0.5pt solid;
                    ...
                    height: 67.5pt; background-color: transparent" width="169">
                    2.国家级科技项目(国家自然科学基金、科技部4类科技计划、发改委和财政部的科技专项等)</td>
                <td width="78" align="center" class="xl32" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent"><span style="font-size: 9pt">重大</span></td>
                <td width="69" align="center" class="xl32" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">重点</td>
                <td width="61" align="center" class="xl32" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">面上</td>
            ...
            <tr height="18" style="font-size: 10pt; font-family: 宋体; height: 13.5pt; mso-height-source: userset">
                <td height="18" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext; border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 13.5pt; background-color: transparent">一级</td>
                <td height="18" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="19" style="font-size: 9pt; font-family: 宋体; height: 14.25pt; mso-height-source: userset">
                <td height="19" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 14.25pt;
                    background-color: transparent">二级</td>
                <td height="19" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 14.25pt;
                    background-color: transparent">一级</td>
                <td height="19" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 14.25pt;
                    background-color: transparent">/</td>
                <td align="center" class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="19" style="font-size: 9pt; font-family: 宋体; height: 14.25pt; mso-height-source: userset">
                ...
                <td height="19" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 14.25pt;
                    background-color: transparent">二级</td>
                <td height="19" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext; border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 14.25pt; background-color: transparent">一级</td>
                <td align="center" class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent"
                    x:num="1">
                    1.0                </td>
            ...
            <tr height="16" style="font-size: 9pt; font-family: 宋体; height: 12pt">
                <td height="16" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 12pt;
                    background-color: transparent">
                    四级</td>
                <td height="16" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 12pt;
                    background-color: transparent">三级</td>
                <td height="16" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 12pt;
                    background-color: transparent">/</td>
                <td align="center" class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="21" style="font-size: 9pt; font-family: 宋体; height: 15.75pt; mso-height-source: userset">
                <td class="xl39" height="63" rowspan="3" style="border-right: windowtext 0.5pt solid;
                    ...
                    height: 47.25pt; background-color: transparent" width="169">
                    3.省部级科技项目（地震行业科研专项、中国地震局及其他部委、各省、直辖市设立的项目）</td>
                <td height="20" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">/</td>
                <td height="20" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">一级</td>
                <td height="20" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">/</td>
                <td height="20" align="center" class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent"
                    x:num="1">
                    1.0                </td>
                <td height="20" align="center" class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="21" style="font-size: 9pt; font-family: 宋体; height: 15.75pt; mso-height-source: userset">
                ...
                <td height="16" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 15.75pt;
                    background-color: transparent">一级</td>
                <td height="16" align="center" class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent"
                    x:num="0.8">
                    0.8                </td>
                <td height="16" align="center" class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="21" style="font-size: 9pt; font-family: 宋体; height: 15.75pt; mso-height-source: userset">
                <td height="21" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 15.75pt;
                    background-color: transparent">
                    /</td>
                <td height="21" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="23" style="font-size: 9pt; font-family: 宋体; height: 17.25pt; mso-height-source: userset">
                <td class="xl41" height="43" rowspan="2" style="border-right: windowtext 0.5pt solid;
                    ...
                    width="169">
                    4.所（省局）级重点科技项目</td>
                <td height="23" align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">
                    /</td>
                <td align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">一级</td>
                <td align="center" valign="middle" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">/</td>
                <td align="center" class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="20" style="font-size: 9pt; font-family: 宋体; height: 15pt; mso-height-source: userset">
                ...
                <td colspan="3" class="xl45" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 139pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">                </td>
                <td width="82" align="center" class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 61pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">
                    技术负责人</td>
                <td width="80" align="center" class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="36" style="font-size: 9pt; font-family: 宋体; height: 27pt; mso-height-source: userset">
                <td height="36" colspan="3" class="xl45" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 139pt; border-bottom: windowtext 0.5pt solid;
                    height: 27pt; background-color: transparent">
                    通过国家地震安全性评定委员会会议评审项目</td>
                <td width="82" align="center" class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 61pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent" x:num="">
                    0.5</td>
                <td width="80" align="center" class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 59pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent" x:num="">
            ...
            <tr height="34" style="font-size: 9pt; font-family: 宋体; height: 25.5pt; mso-height-source: userset">
                <td height="34" colspan="3" class="xl45" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 139pt; border-bottom: windowtext 0.5pt solid;
            ...
            <tr height="34" style="font-size: 9pt; font-family: 宋体; height: 25.5pt; mso-height-source: userset">
                <td class="xl41" height="34" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    ...
                    height: 25.5pt; background-color: transparent" width="169">
                    6.研究生培养</td>
                <td class="xl43" colspan="5" style="border-right: #dcd9a6; border-top: windowtext 0.5pt solid;
                ...
                <td class="xl26" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    ...
                    background-color: transparent; text-align: center" width="90">
                    <span style="font-size: 10pt">
            ...
            <tr height="38" style="font-size: 10pt; font-family: 宋体; height: 28.5pt; mso-height-source: userset">
                <td class="xl30" height="38" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    ...
                    height: 28.5pt; background-color: transparent" width="41">
                    <span style="font-size: 9pt">计分<br />
                        方法</span></td>
                <td class="xl43" colspan="7" style="border-right: black 0.5pt solid; border-top: windowtext 0.5pt solid;
                    font-size: 9pt; border-left: windowtext; width: 458pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">
                    最后取第1条至第6条中最高的5项得分之和为“承担项目和任务”的得分</td>
            ...
            <tr height="17" style="font-weight: bold; font-size: 10pt; font-family: 宋体; height: 12.75pt;
                ...
                <td class="xl30" height="242" rowspan="8" style="border-right: windowtext 0.5pt solid;
                    border-top: windowtext; border-left: windowtext 0.5pt solid; width: 29pt; border-bottom: windowtext 0.5pt solid;
                    height: 181.5pt; background-color: transparent" width="41">
                    <span style="font-size: 9pt">
                    论著报告</span></td>
                <td class="xl41" rowspan="5" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    ...
                    background-color: transparent" width="169">
                    1.论文在期刊上发表（不便发表的工程技术报告按一般期刊发表的论文评分）</td>
                <td colspan="3" class="xl32" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">                </td>
                <td class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; border-bottom: windowtext 0.5pt solid;
            ...
            <tr height="17" style="font-size: 10pt; font-family: 宋体; height: 12.75pt; mso-height-source: userset">
                ...
                <td class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent; height: 13pt;" x:num="1">
                    1.0                </td>
                <td class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent; height: 13pt;" x:num="0.1">
                    0.1                </td>
            </tr>
            <tr height="17" style="font-size: 9pt; font-family: 宋体; height: 12.75pt; mso-height-source: userset">
                <td height="17" colspan="3" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="52" style="font-size: 9pt; font-family: 宋体; height: 39pt; mso-height-source: userset">
                <td class="xl41" height="52" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 125pt; border-bottom: windowtext 0.5pt solid;
                    height: 39pt; background-color: transparent" width="169" x:str="   ">
                    <span style="mso-spacerun: yes">&nbsp; &nbsp;</span></td>
                <td class="xl45" colspan="5" style="border-right: windowtext 0.5pt solid; border-top: windowtext 0.5pt solid;
                    border-left: windowtext; width: 259pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">
                    第1作者得0.2分，其中被ISTP收录加0.3,非第1作者得0.1分。在国际学术机构组织的会议上宣读的特邀或主题报告第1作者得0.7分。</td>
            </tr>
            <tr height="35" style="font-size: 9pt; font-family: 宋体; height: 26.25pt; mso-height-source: userset">
                <td class="xl41" height="35" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 125pt; border-bottom: windowtext 0.5pt solid;
                    height: 26.25pt; background-color: transparent" width="169">
                    3.撰写出版20万字以上专著</td>
                <td class="xl45" colspan="5" style="border-right: windowtext 0.5pt solid; border-top: windowtext 0.5pt solid;
                    border-left: windowtext; width: 259pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">
            ...
            <tr height="70" style="font-size: 9pt; font-family: 宋体; height: 52.5pt; mso-height-source: userset">
                <td class="xl45" height="70" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 125pt; border-bottom: windowtext 0.5pt solid;
                    height: 52.5pt; background-color: transparent" width="169">
                    4.完成有关报告</td>
                <td class="xl45" colspan="5" style="border-right: windowtext 0.5pt solid; border-top: windowtext 0.5pt solid;
                    border-left: windowtext; width: 259pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">
            ...
            <tr height="44" style="font-size: 10pt; font-family: 宋体; height: 33pt; mso-height-source: userset">
                <td class="xl30" height="488" rowspan="14" style="border-right: windowtext 0.5pt solid;
                    border-top: windowtext; border-left: windowtext 0.5pt solid; width: 29pt; border-bottom: windowtext 0.5pt solid;
                    height: 366pt; background-color: transparent" width="41">
                    <span style="font-size: 9pt">
                    业绩成果</span></td>
                ...
                <td class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; width: 59pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent; text-align: center" width="80">
                    前三分之一<br />
                    完成人</td>
                <td class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; width: 74pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent; text-align: center" width="101">
                    其他<br />
                    主要完成人</td>
                <td class="xl27" rowspan="8" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 10pt; border-left: windowtext 0.5pt solid; border-bottom: black 0.5pt solid;
            ...
            <tr height="21" style="font-size: 10pt; font-family: 宋体; height: 15.75pt; mso-height-source: userset">
                <td height="21" colspan="3" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; height: 15.75pt;
                    background-color: transparent">
            ...
            <tr height="21" style="font-size: 9pt; font-family: 宋体; height: 15.75pt; mso-height-source: userset">
                <td height="21" colspan="3" class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 139pt; border-bottom: windowtext 0.5pt solid;
            ...
            <tr height="21" style="font-size: 9pt; font-family: 宋体; height: 15.75pt; mso-height-source: userset">
                <td class="xl41" height="59" rowspan="3" style="border-right: windowtext 0.5pt solid;
                    ...
                    height: 44.25pt; background-color: transparent" width="169">
            ...
            <tr height="22" style="font-size: 9pt; font-family: 宋体; height: 16.5pt; mso-height-source: userset">
                <td height="22" colspan="3" class="xl33" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="16" style="font-size: 9pt; font-family: 宋体; height: 12pt">
                <td colspan="3" class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 139pt; border-bottom: windowtext 0.5pt solid;
                    height: 12pt; background-color: transparent">
                    三等奖</td>
                <td class="xl36" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
            ...
            <tr height="37" style="font-size: 9pt; font-family: 宋体; height: 27.75pt; mso-height-source: userset">
                <td class="xl41" height="37" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 125pt; border-bottom: windowtext 0.5pt solid;
                    height: 27.75pt; background-color: transparent" width="169">
                    3.获得其他奖励</td>
                <td class="xl43" colspan="6" style="border-right: black 0.5pt solid; border-top: windowtext 0.5pt solid;
            ...
            <tr height="32" style="font-size: 9pt; font-family: 宋体; height: 24pt; mso-height-source: userset">
                <td class="xl45" height="103" rowspan="2" style="border-right: windowtext 0.5pt solid;
                    border-top: windowtext; border-left: windowtext 0.5pt solid; width: 125pt; border-bottom: windowtext 0.5pt solid;
                    height: 77.25pt; background-color: transparent" width="169">
                    4.在地震预报工作方面</td>
                <td colspan="3" class="xl45" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 139pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">                </td>
                <td class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 61pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent; text-align: center" width="82">
                    5－5.9级<br />
                    地震</td>
                <td class="xl30" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 59pt; border-bottom: windowtext 0.5pt solid;
            ...
            <tr height="71" style="font-size: 10pt; font-family: 宋体; height: 53.25pt; mso-height-source: userset">
                <td height="71" colspan="3" class="xl45" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 139pt; border-bottom: windowtext 0.5pt solid;
                    height: 53.25pt; background-color: transparent">
                    <span style="font-size: 9pt">
                ...
                <td class="xl48" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; width: 61pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent" width="82" x:num="1">
                    1.0                </td>
                <td class="xl48" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; width: 59pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent" width="80" x:num="1.5">
                    1.5                </td>
                <td class="xl48" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    font-size: 9pt; border-left: windowtext; width: 74pt; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent" width="101" x:num="2">
                    2.0                </td>
            </tr>
            <tr height="48" style="font-size: 9pt; font-family: 宋体; height: 36pt; mso-height-source: userset">
                <td class="xl45" height="48" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 125pt; border-bottom: windowtext 0.5pt solid;
                    height: 36pt; background-color: transparent" width="169">
            ...
            <tr height="16" style="font-size: 10pt; font-family: 宋体; height: 12pt">
                <td class="xl41" height="16" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 125pt; border-bottom: windowtext 0.5pt solid;
                    height: 12pt; background-color: transparent" width="169">
                    <span style="font-size: 9pt">
                    6.获得国家专利</span></td>
                <td class="xl49" colspan="6" style="border-right: black 0.5pt solid; border-top: windowtext 0.5pt solid;
                    font-size: 9pt; border-left: windowtext; border-bottom: windowtext 0.5pt solid;
                    background-color: transparent">
            ...
            <tr height="82" style="font-size: 10pt; font-family: 宋体; height: 61.5pt; mso-height-source: userset">
                <td class="xl41" height="82" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; width: 125pt; border-bottom: windowtext 0.5pt solid;
                    height: 61.5pt; background-color: transparent" width="169">
            ...
            <tr height="35" style="font-size: 10pt; font-family: 宋体; height: 26.25pt; mso-height-source: userset">
                <td class="xl30" height="35" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext 0.5pt solid; width: 29pt; border-bottom: windowtext 0.5pt solid;
                    height: 26.25pt; background-color: transparent" width="41">
                    <span style="font-size: 9pt">计分<br />
                        方法</span></td>
                <td class="xl43" colspan="7" style="border-right: black 0.5pt solid; border-top: windowtext 0.5pt solid;
                    font-size: 9pt; border-left: windowtext; width: 458pt; border-bottom: windowtext 0.5pt solid;
            ...
            <tr height="16" style="font-size: 10pt; font-family: 宋体; height: 12pt">
                ...
                <td class="xl53" colspan="7" style="border-right: black 0.5pt solid; border-top: windowtext 0.5pt solid;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent">                </td>
                <td class="xl25" style="border-right: windowtext 0.5pt solid; border-top: windowtext;
                    border-left: windowtext; border-bottom: windowtext 0.5pt solid; background-color: transparent;
                    text-align: center">
