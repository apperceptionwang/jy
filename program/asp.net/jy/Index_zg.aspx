<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index_zg.aspx.cs" Inherits="Index_zg" %>
                            ...
                            <table cellpadding="0" cellspacing="0" height="400" width="100%">
                                <tr>
                                    <td align="center" valign="middle" style="text-align: center">
                                        <a href="admin/Admin_Login.aspx?type=zgcpry">
                                            <img border="0" src="images/dot (2).jpg" align="absmiddle" />进入 个人申报系统</a>
                                        &nbsp; &nbsp; &nbsp;
                                        <br />
                                        <br />
                                        <br />
                                        <a href="admin/Admin_Login.aspx?type=zgrs">
                                            <img border="0" src="images/dot (2).jpg" align="absmiddle" />进入 单位审核系统</a>
                                        &nbsp; &nbsp; &nbsp;<br />
                                        <br />
                                        <br />
                                        &nbsp; &nbsp;&nbsp;
