<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReSet.aspx.cs" Inherits="VOD.Admin.ReSet" %>
			...
			<table cellpadding="3" cellspacing="1" border="0" class="tableBorder" align="center">
				...
				<tr>
					<td class="bodytitle" height="23">
						本功能用于修改后台设置（会员类型，影片类型）的内容时重新读取设置供影院前台使用
						
				</tr>
				<tr>
					<td class="forumRowHighlight" height="23">
					<asp:Button ID="btn_Reset" runat="server" OnClick="btn_Reset_Click" Text="点击重置"  />
						</td>
				</tr>
			</table>
			<br>
