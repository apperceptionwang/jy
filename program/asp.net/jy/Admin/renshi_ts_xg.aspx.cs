...
public partial class Admin_renshi_ts_xg : System.Web.UI.Page
{
    ...
    private void bindData()
    {
        string strqry = "SELECT ID,sfzh, yourname,xingbie, " +
            ...
            "jszc, xzzw, iif(isnull(tj_flag),'未审核',tj_flag) as tuijian,edit_flag,fenlei FROM ts_cpry where gzdw = '" + Session["admin_id"].ToString() + "' ";
    ...
    protected void btn_Ok_Click(object sender, EventArgs e)
    {
        ...
        {
            //删除
            strsql = string.Format("update ts_cpry set fenlei = '" + Dropdownlist1.SelectedItem.Text + "' where id in {0}", strOpid);
    ...
    protected void rbtnListSave()
    {
        ...
        for (int i = 0; i < this.GridView1.Rows.Count; i++)    //循环GridView每一行
        {
            ...
            str_sql = "update ts_cpry set edit_flag =" + str_xg + " where sfzh = '" + str_sfzh + "'";
