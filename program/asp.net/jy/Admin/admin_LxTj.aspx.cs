...
public partial class admin_LxTj : System.Web.UI.Page
{
    ...
    {
        str_sql = " select appNo, ktmc, sqbm, sqr, Status,yj2,id,name as xmzt, " +
                  ...
                  " and    Status between (select url from t_dict where flm = 11 and bm =3) and (select url from t_dict where flm = 11 and bm =4) " +                  
    ...
    {
        TD_AddUser.Visible = false;
        str_sql = string.Format("update t_teacher_list set yj2 = '" + tbx_yj2.Text + "' where appNo ='" + lbl_appNo.Text + "'");
    ...
    protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        tbx_yj2.Text = dv.Table.Rows[e.NewSelectedIndex + (AspNetPager1.CurrentPageIndex - 1) * AspNetPager1.PageSize]["yj2"].ToString();
    }
    #endregion
