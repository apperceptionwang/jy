...
public partial class admin_Lxzjxm1 : System.Web.UI.Page
{
    ...
    {
        str_sql = "delete from t_zjry1 where left(appNo,4)=year(date()) ";
        DBFun.ExecuteSql(str_sql);
        str_sql = " insert into t_zjry1 (zjNo,appNo) " +
                  " select loginname,appNo from t_expertlist1 a,t_teacher_list b "+
                  " where  a.appyear=b.appyear and a.cGroup =b.cGroup1 and a.appyear=year(date()) and cGroup1 is not null ";
