<%@ Page Language="C#" AutoEventWireup="true" CodeFile="renshi_ej_tj.aspx.cs" Inherits="Admin_renshi_ej_tj" %>
						...
						<td bgColor="#ffffff" valign="top">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="xrgw" HeaderText="现任岗位" />
                                    <asp:BoundField DataField="gwxl" HeaderText="岗位系列" />
