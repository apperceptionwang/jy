...
public partial class Admin_renshi_ej_yhgl : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (CommFun.IsTimeOut("yj", Session["dept_id"].ToString()))
        {
    ...
    {
        //绑定GridView
        string str_sql = "select * from ej_cpry where dw = '" + Session["admin_id"].ToString() + "'";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string str_sql = "delete from ej_cpry where sfzh = '" +
