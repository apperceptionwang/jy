<%@ Page Language="C#" AutoEventWireup="true" CodeFile="renshi_tj.aspx.cs" Inherits="Admin_renshi_tj" %>
				...
				<table class="tableBorder" id="table2" style="WIDTH: 100%" height="240" cellSpacing="1"
					...
					<TR>
						<TD class="forumRowHighlight"><FONT face="宋体"><span style="background-color: #e4edf9">
                            ...
                            <asp:LinkButton ID="lbtn_AllYes" runat="server" OnClick="lbtn_AllYes_Click">全部推荐</asp:LinkButton>&nbsp;
                                        &nbsp;<asp:LinkButton ID="lbtn_AllNo" runat="server" OnClick="lbtn_AllNo_Click">全部不推荐</asp:LinkButton>&nbsp;
