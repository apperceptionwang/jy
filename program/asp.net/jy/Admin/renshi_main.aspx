<%@ Page Language="C#" AutoEventWireup="true" CodeFile="renshi_main.aspx.cs" Inherits="admin_renshi_main" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="3" cellspacing="1" border="0" class="tableBorder" align="center">
				...
				<tr>
					<td width="20%" class="forumRow" height="23" align="right">联系方式&nbsp;&nbsp; </td>
				...
				<tr>
					...
					<td width="80%" class="forumRow">
                        <asp:HyperLink ID="HyperLink1" runat="server" 
                            NavigateUrl="../UploadFile/部门管理员使用手册.doc">部门管理员使用手册</asp:HyperLink>
                    </td>
				</tr>
			</table>
			<br>
