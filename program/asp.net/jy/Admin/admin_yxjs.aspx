<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_yxjs.aspx.cs" Inherits="Admin_admin_yxjs" %>
									...
									<table id="table20" height="30" cellSpacing="0" cellPadding="0" border="0" style="width: 662px" runat="server" visible="true">
										<tr>
											...
											<td style="FONT-SIZE: 12px; COLOR: #000000; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; height: 30px; width: 593px;" colspan="3"><asp:dropdownlist id="DwPath" runat="server" Width="171px" AutoPostBack="True" OnSelectedIndexChanged="DwPath_SelectedIndexChanged">
                                                <asp:ListItem Value="地震科学系">地震科学系</asp:ListItem>
                                                <asp:ListItem Value="防灾工程系">防灾工程系</asp:ListItem>
                                                <asp:ListItem Value="防灾仪器系">防灾仪器系</asp:ListItem>
                                                <asp:ListItem Value="灾害信息工程系">灾害信息工程系</asp:ListItem>
                                                <asp:ListItem Value="经济管理系">经济管理系</asp:ListItem>
                                                <asp:ListItem>人文社科系</asp:ListItem>
                                                <asp:ListItem>外语系</asp:ListItem>
                                            </asp:dropdownlist>
                                                分类码：<asp:TextBox ID="tbx_flm" runat="server"></asp:TextBox>编码：
                                                <asp:TextBox ID="tbx_bm" runat="server"></asp:TextBox>
