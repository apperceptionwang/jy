...
public partial class Admin_renshi_yhgl : System.Web.UI.Page
{
    ...
    {
        string str_sql = "select * from cpry where gzdw = '" + Session["admin_id"].ToString() + "'";
    ...
    protected void btn_confirm_Click(object sender, EventArgs e)
    {
        ...
        if (lbl_editflag.Text == "insert")
        {
            ...
            str_sql = string.Format("insert into cpry (yourname, pwd, sfzh,tj_flag,gzdw) values ( '{0}',  '{1}', '{2}','{3}','{4}')",
