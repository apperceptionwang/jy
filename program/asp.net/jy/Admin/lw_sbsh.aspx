<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lw_sbsh.aspx.cs" Inherits="Admin_lw_sbsh" %>
				...
				<table class="tableBorder" id="table2" style="WIDTH: 100%" height="240" cellSpacing="1"
						...
						<td bgColor="#ffffff" style="height: 342px" valign="top">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                ...
                                <Columns>
                                    ...
                                    <asp:ButtonField CommandName="select" DataTextField="yourname" HeaderText="作者姓名" Text="按钮" />
                                    <asp:BoundField DataField="name" HeaderText="推荐单位" />
					...
					<tr>
						<td class="forumRowHighlight" style="height: 30px">
                            ...
                            <asp:Button ID="btn_zjpsqk" runat="server" OnClick="btn_zjpsqk_Click" Text="导出专家评审情况一览表" Width="165px" /><span
                                style="color: #ff0000"><asp:Button ID="btn_expAllInfo" runat="server" OnClick="btn_expAllInfo_Click" Text="导出所有信息到EXCEL" /></span></td>
					</tr>
                    <tr>
