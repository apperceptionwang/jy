<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_ZqResult.aspx.cs" Inherits="admin_Zq" %>
						...
						<td bgColor="#ffffff" style="height: 302px" valign="top">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                                ...
                                <asp:TemplateField HeaderText="序号">
                                    ...
                                    <asp:BoundField HeaderText="评委1" DataField="tp1" >
                                    <ItemStyle Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="tp2" HeaderText="评委2" >
                                    <ItemStyle Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="评委3" DataField="tp3" >
                                    <ItemStyle Width="50px" />
                                    <ItemStyle Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="评委4" DataField="tp4" >
                                    <ItemStyle Width="50px" />
                                    <ItemStyle Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="tp5" HeaderText="评委5">
                                    <ItemStyle Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ps2" HeaderText="同意立项票数">
                                    <ItemStyle Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="cGroup2" HeaderText="分组">
                                    <ItemStyle Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="pm2" HeaderText="排名">
