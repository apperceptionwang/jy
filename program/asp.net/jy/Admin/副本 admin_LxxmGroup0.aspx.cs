...
public partial class admin_LxxmGroup0 : System.Web.UI.Page
{
    ...
    protected void btn_Ok_Click(object sender, EventArgs e)
    {
        ...
        {
            str_sql = string.Format("update t_teacher_list set cGroup0 = '" + dw_group.SelectedValue + "' where appNo in {0}", strOpid);
    ...
    protected void btn_drop_Click(object sender, EventArgs e)
    {
        ...
        {
            //分组
            strsql = string.Format("update t_teacher_list set cGroup0 = '' where appNo in {0}", strOpid);
