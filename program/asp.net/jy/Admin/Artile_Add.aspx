<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Artile_Add.aspx.cs" Inherits="Admin_Artile_Add" %>
									...
									<table id="table20" height="30" cellSpacing="0" cellPadding="0" border="0" style="width: 662px" runat="server" visible="true">
										<tr>
											<td style="FONT-SIZE: 12px; COLOR: #000000; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; height: 30px;"
												width="69">
                                                所属类别：</td>
											<td style="FONT-SIZE: 12px; COLOR: #000000; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; height: 30px; width: 593px;" colspan="3"><asp:dropdownlist id="DwPath" runat="server" Width="155px">
                                                <asp:ListItem Value="0">正高级</asp:ListItem>
                                                <asp:ListItem Value="1">专业技术二级</asp:ListItem>
                                                <asp:ListItem Value="2">特殊津贴人员</asp:ListItem>
                                            </asp:dropdownlist></td>
										</tr>
									</table>
								</td>
									...
									<table border="0" cellPadding="0" cellSpacing="2" id="table19" style="width: 664px; height: 66px">
										<tr>
											<td style="WIDTH: 64px; height: 9px;">
                                                标题名称：</td>
											<td style="height: 9px;" colspan="4"><asp:textbox id="tbx_title" runat="server" Width="317px" ></asp:textbox>
										...
										<TR>
											...
											<TD colSpan="3" style="height: 6px; width: 589px;">
                                                ...
                                                <table id="tb_body" style="DISPLAY: none" cellSpacing="0" cellPadding="0" width="99%" border="0">
													<tr>
														<td style="height: 21px"><INPUT id="myfile" 
