<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_LxResult0.aspx.cs" Inherits="admin_Lx" %>
						...
						<td bgColor="#ffffff" style="height: 302px" valign="top">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                                ...
                                <asp:TemplateField HeaderText="序号">
                                    ...
                                    <asp:BoundField DataField="ps0" HeaderText="同意立项票数">
                                    <ItemStyle Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="cGroup0" HeaderText="分组">
                                    <ItemStyle Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="pm0" HeaderText="排名">
