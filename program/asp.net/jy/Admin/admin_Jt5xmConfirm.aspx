<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_Jt5xmConfirm.aspx.cs" Inherits="admin_Jt5xmConfirm" %>
				...
				<table class="tableBorder" id="table2" style="WIDTH: 100%" height="240" cellSpacing="1"
					...
					<tr>
						<th id="tabletitlelink" style="FONT-WEIGHT: bold; FONT-SIZE: 12px; BACKGROUND-IMAGE: url(images/admin_bg_1.gif); COLOR: white; BACKGROUND-COLOR: #4455aa"
							align="left" height="20" colspan="3">
                            课题结题确认&nbsp;</th></tr>
					<tr>
						<TD class="forumRow" 
                            vAlign="middle" height="20" align="left" colspan="3">
                    ...
                    <tr>
						<TD class="forumRowHighlight" 
                            ...
                            项目状态：</TD>
						<TD class="forumRowHighlight" 
                            vAlign="middle" height="20" style="width: 92%" colspan="2">
					...
					<tr>
						<TD class="forumRowHighlight" 
                            ...
                            类别： </TD>
						<TD class="forumRowHighlight" 
                            vAlign="middle" height="20" style="width: 85%">
					...
					<tr>
						<td bgColor="#ffffff"  valign="top" height="400" colspan="3">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="appNo" HeaderText="申报号">
        ...
        showcustominfosection="Left" width="100%" meta:resourceKey="AspNetPager1" style="font-size:14px" InputBoxStyle="width:19px"
					...
					<tr>
						<TD id ="td_search2" runat=server visible=True class="forumRowHighlight" 
                            vAlign="middle" height="20" colspan="3" align = right >
					...
					<tr>
						<TD id ="td_search1" runat=server visible=True class="forumRowHighlight" 
                            vAlign="middle" height="20" colspan="3" >
                            导出到Excel：&nbsp;
					...
					<tr>
                        <TD class="forumRowHighlight" style="height: 30px" colspan="3">
                            <FONT face="宋体"><span style="background-color: #e4edf9; font-size: 12px;">对选择的课题进行操作&nbsp; </span>
                                <asp:Button ID="btn_ok" runat="server" OnClick="btn_Ok_Click" Text="立项" 
                                Width="51px" CssClass="style2" />
                                &nbsp;&nbsp;
                                <asp:Button ID="btn_qxlx" runat="server" OnClick="btn_qxlx_Click" Text="取消立项" 
                                Width="61px" CssClass="style2" />
                                </font></td>
                    </tr>
                    </table>
			</div>
