<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_ZqTj.aspx.cs" Inherits="admin_Zq" %>
                                ...
                                <asp:TemplateField HeaderText="序号">
                                    ...
                                    <ItemTemplate>
									        <asp:RadioButtonList ID="rbtnList_tjjg" runat="server" Height="20px" 
                                                ...
                                                <asp:ListItem Value="6">推荐</asp:ListItem>
                                                <asp:ListItem Value="5">不推荐</asp:ListItem>
                                            </asp:RadioButtonList>
									</ItemTemplate>
