<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tbsm.aspx.cs" Inherits="Admin_tbsm" %>
								...
								<td style="FONT-SIZE: 12px; COLOR: #000000; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; width: 47px; height: 50px;"
									...
									<table id="table20" height="30" cellSpacing="0" cellPadding="0" border="0" style="width: 662px" runat="server" visible="false">
										<tr>
											...
											<td style="FONT-SIZE: 12px; COLOR: #000000; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; height: 30px; width: 593px;" colspan="3"><asp:dropdownlist id="DwPath" runat="server" Width="92px" Visible="False">
                                                <asp:ListItem>招生</asp:ListItem>
