<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_zjList.aspx.cs" Inherits="admin_zjList" %>
				...
				<table class="tableBorder" id="table2" style="WIDTH: 100%" height="240" cellSpacing="1"
					...
					<tr>
						<TD class="forumRowHighlight" vAlign="middle" height="30">
                            查找年度：<asp:DropDownList 
                                ID="ddlist_year" runat="server" Width="200px">
                            </asp:DropDownList>
                            <asp:Button ID="btn_search0" runat="server" OnClick="btn_search_Click" 
                                Text="查找" />
                            </TD>
						<TD class="forumRowHighlight" vAlign="middle" height="30">
                            每页显示条数<asp:DropDownList 
                                ID="ddl_PageSize" runat="server" AutoPostBack="True" 
                                onselectedindexchanged="ddl_PageSize_SelectedIndexChanged" Height="16px">
					...
					<tr>
						<TD class="forumRowHighlight" vAlign="middle" height="30">
                            查找类别：<asp:DropDownList 
                                ...
                                <asp:ListItem Value="tj_flag">是否提交</asp:ListItem>
                                <asp:ListItem Value="cGroup">分组</asp:ListItem>
                            </asp:DropDownList>&nbsp;
