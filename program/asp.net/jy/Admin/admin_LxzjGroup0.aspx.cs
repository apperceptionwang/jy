...
public partial class admin_LxzjGroup0 : System.Web.UI.Page
{
    ...
    protected void bindData()
    {
        str_sql = " select a.LoginName,UserName,szbm,zc,zy,jb,tj_flag,cGroup "+
                  " from   t_Expert as a,t_ExpertList0 as b " +
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        dv = DBFun.GetDataView(str_sql);
        str_sql = "delete from t_ExpertList0 where appyear=year(date()) and LoginName = '" + dv.Table.Rows[e.RowIndex + (AspNetPager1.CurrentPageIndex - 1) * AspNetPager1.PageSize]["LoginName"].ToString() + "'";
    ...
    protected void btn_Ok_Click(object sender, EventArgs e)
    {
        ...
        {
            //分组
            strsql = string.Format("update t_ExpertList0 set cGroup = '" + dw_group.SelectedValue + "' where appyear=year(date()) and LoginName in {0}", strOpid);
    ...
    protected void btn_drop_Click(object sender, EventArgs e)
    {
        ...
        {
            //分组
            strsql = string.Format("update t_ExpertList0 set cGroup = '' where appyear=year(date()) and LoginName in {0}", strOpid);
            if (DBFun.ExecuteUpdate(strsql))
            {
    ...
    {
        Response.Redirect("admin_zjImport.aspx?type=0");
    }
    #endregion
