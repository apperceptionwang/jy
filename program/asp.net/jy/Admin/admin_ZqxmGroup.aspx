<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_ZqxmGroup.aspx.cs" Inherits="admin_Zq" %>
						...
						<td bgColor="#ffffff"  valign="top" height="400">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="tjrws" HeaderText="提交任务书" />
                                    <asp:BoundField DataField="tjzqjc" HeaderText="提交中期检查">
