<%@ Page Language="C#" AutoEventWireup="true" CodeFile="renshi_lw_xg.aspx.cs" Inherits="Admin_renshi_lw_xg" %>
				...
				<table class="tableBorder" id="table2" style="WIDTH: 100%" height="240" cellSpacing="1"
					...
					<tr>
						<td class="forumRowHighlight" style="height: 30px">
                            <table style="width: 416px; height: 11px" cellpadding="0" cellspacing="0" id="TABLE1" runat="server" visible="false"><tr><td style="width: 2px; height: 17px;"></td><td style="width: 3px; height: 17px;">
