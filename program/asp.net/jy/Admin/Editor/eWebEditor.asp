...
<tr><td height=25>
	...
	<td align=center style="font-size:9pt">远程图片自动上传<input type="checkbox" onclick="javascript:if (cutremote.checked==true){config.AutoRemote=1}else{config.AutoRemote=0}" checked name="cutremote"></td>
	<td align=right>
		<table border=0 cellpadding=0 cellspacing=0 height=20>
		<tr>
