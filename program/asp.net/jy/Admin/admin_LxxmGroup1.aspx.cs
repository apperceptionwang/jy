...
public partial class admin_LxxmGroup1 : System.Web.UI.Page
{
    ...
    protected void btn_Ok_Click(object sender, EventArgs e)
    {
        ...
        {
            str_sql = string.Format("update t_teacher_list set cGroup1 = '" + dw_group.SelectedValue + "' where appNo in {0}", strOpid);
