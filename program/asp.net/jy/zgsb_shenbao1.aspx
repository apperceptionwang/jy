<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zgsb_shenbao1.aspx.cs" Inherits="zgsb_shenbao1" %>
...
width=680 align=center border=0>
    <TBODY>
      ...
      width="100%" align=center border=1>
          ...
          快速搜索<br />
                      <asp:LinkButton ID="lbtn_Course" runat="server">按课程</asp:LinkButton>&nbsp;
                      <br />
                      <asp:LinkButton ID="lbtn_Teacher" runat="server">按人员</asp:LinkButton>&nbsp;
                      <br />
                      <asp:LinkButton ID="lbtn_" runat="server">综合查询</asp:LinkButton></TD>
                </TR>
                <TR>
      ...
      width="100%" align=center border=1>
            <TBODY>
              ...
              <TR>
                <TD colspan=4> <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Height="1px"
                        Width="464px" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal">
                      <Columns>
                          <asp:TemplateField>
                              <ItemTemplate>
                          ...
                          <asp:ButtonField CommandName="edit" DataTextField="mc" Text="下载" HeaderText="参评人员" >
                          <HeaderStyle Font-Size="Smaller" HorizontalAlign="Left" /></asp:ButtonField>
                          <asp:HyperLinkField HeaderText="评价专家" DataTextField="fzr" >
                              <HeaderStyle Font-Size="Smaller" HorizontalAlign="Left" />
                          </asp:HyperLinkField>
                          <asp:BoundField HeaderText="评价分数" DataField="totalbrowser" >
                              <HeaderStyle Font-Size="Smaller" HorizontalAlign="Left" />
                          </asp:BoundField>
                      </Columns>
