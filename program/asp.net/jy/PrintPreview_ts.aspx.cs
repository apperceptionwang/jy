...
public partial class PrintPreview_ts : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        //Session["sfzh"] = "230103197803220939";
        //Session["sfzh"] = "111111111111111";
        //Response.Write(@"<script>alert('打印程序调试中，请稍后登陆打印！');location.href = './default.aspx';</script>");

        //if (Session["admin_name"] == null)
        //{
        //    if (Request.Browser.MajorVersion != 7)
        //    {
        //        Response.Write(@"<script>alert('请使用IE7.0版本的浏览器打印！');location.href = './default.aspx';</script>");
        //        return;
        //    }
        //    //弹出窗口
        //    Response.Write("<script>showModalDialog('default5.aspx','example04','dialogWidth:660px;dialogHeight:220px;dialogLeft:200px;dialogTop:150px;center:yes;help:yes;resizable:no;status:yes');</script>");
        //}
        if (!IsPostBack)
        {
            bindData();
