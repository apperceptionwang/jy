<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index_jy.aspx.cs" Inherits="Index_jy" %>
                            ...
                            <table cellpadding="0" cellspacing="0" height="400" width="100%">
                                <tr>
                                    <td align="center" valign="middle" style="text-align: center">
                                        <a href="admin/Admin_Login.aspx?type=jycpry">
                                            <img border="0" src="images/dot (2).jpg" align="absmiddle" />进入 个人申报系统</a>
                                        &nbsp; &nbsp; &nbsp;
                                        <br />
                                        <br />
                                        <br />
                                        <a href="admin/Admin_Login.aspx?type=jyrs">
                                            <img border="0" src="images/dot (2).jpg" align="absmiddle" />进入 部门审核系统</a>
                                        &nbsp; &nbsp; &nbsp;<br />
                                        <br />
                                        <br />
                                        &nbsp; &nbsp;&nbsp;
                                        <a href="admin/Admin_Login.aspx?type=jyzj">
                                            <img border="0" src="images/dot (2).jpg" align="absmiddle" />进入 专家评审系统</a>
                                         &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" valign="middle" class="style1" style="text-align: left">
                                        &nbsp;&nbsp;&nbsp;
