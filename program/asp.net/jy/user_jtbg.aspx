<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_jtbg.aspx.cs" Inherits="user" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="3" cellspacing="1" border="0" class="tableBorder" align="center">
				...
				<tr>
					<td height="23">
                        <asp:HyperLink ID="hl_2" runat="server" ForeColor="#000066" 
                            NavigateUrl="./templete/防灾科技学院教研教改项目结题验收申请表.doc">下载项目结题申请表模板</asp:HyperLink>
                    </td>
				</tr>
				<tr>
				...
				<tr>
					<td height="23">
                        <asp:HyperLink ID="hl_1" runat="server" ForeColor="#000066">查看项目结题申请表</asp:HyperLink>
                    </td>
				</tr>
				<tr>
