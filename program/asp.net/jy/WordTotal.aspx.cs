...
public partial class WordTotal : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        TextBox1.Text = System.Text.RegularExpressions.Regex.Matches(S, @"\w+").Count.ToString();
        Count(S);
    }

    protected void Button2_Click(object sender, EventArgs e)
    {
        TextBox1.Text =  chang(text1.Value);
    }
    ...
    {
       TextBox1.Text = GetFirstPYLetter(text1.Value);
    }
    ...
    //{
        ...
        //savefile.FileName = "公司名称" +
        //    System.DateTime.Now.ToString("yyyy年MM月dd日HH时mm分ss秒");//格式转换如此简单
        ...
        //    try
        //    {
        //        string path = Application.StartupPath + "\\app_data\\zjb.mdb";
